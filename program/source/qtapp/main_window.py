...
from program.source.qtapp.editors import InputEditor, OutputViewer
from program.source.qtapp.options import OptionsDialog

# Sprites liegen unter program/sprites (eine Ebene ueber source).
SPRITE_DIR = Path(__file__).resolve().parents[2] / "sprites"
